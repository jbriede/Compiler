...
compiler: main.o logger.o parser.o lexer.o Makefile
	g++ -o build/j build/main.o build/logger.o build/parser.o build/lexer.o

main.o: source/main.cpp source/Shared.h source/Parser.h source/Lexer.h
...
debug: main_d.o logger_d.o parser_d.o lexer_d.o  Makefile
	g++ -o build/j_d build/main_d.o build/logger_d.o build/parser_d.o build/lexer_d.o

main_d.o: source/main.cpp source/Shared.h source/Parser.h source/Lexer.h source/Token.h
